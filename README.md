...
- **Katalogas** — ~1700 objektų: visi 110 Mesjė, NGC (iki 12ᵐ), IC, Sharpless (Sh2) emisiniai ūkai, Barnard tamsieji ūkai, Collinder spiečiai — įskaitant populiariausius astrofotografijos taikinius (Širdies, Sielos, Kalifornijos, Arklio galvos ūkai ir kt.). Filtrai pagal katalogą, tipą, žvaigždyną, sezoną, ryškį, sudėtingumą; paieška.
